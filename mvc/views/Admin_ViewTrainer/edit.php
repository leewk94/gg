...
<form method="post" action="<?php echo URL;?>Admin_ViewTrainer/editSave/<?php echo $this->trainer[0]['traID']; ?>">
	<table>
...
foreach($this->changePassword as $key => $value) {
                echo '<tr>';
		echo '<td>
				<a href="'.URL.'Admin_ViewTrainer/changePassword/'.$value['userid'].'">Change Password</a>';
		echo '</tr>';
}
?>
</table>
